...
<head>
    ...
    <link href="<?= URL_TEMPLATE ?>font-awesome/css/font-awesome.min.css" rel="stylesheet">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="<?= URL_TEMPLATE ?>index.html">WEBAPPLAYERS</a>
                </div>
        ...
        <div class="item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <img src="<?= URL_TEMPLATE ?>img/landing/laptop.png" alt="laptop"/>
                </div>
            </div>
...
<section  class="container features">
    <div class="row">
        <div class="col-lg-12 text-center">
            ...
            <h1>Over 70+ unique view<br/> <span class="navy"> with many custom components</span> </h1>
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="<?= URL_TEMPLATE ?>img/landing/perspective.png" alt="dashboard" class="img-responsive">
        </div>
    ...
    <div class="row features-block">
        <div class="col-lg-6 features-text wow fadeInLeft">
            ...
            <a href="<?= URL_TEMPLATE ?>" class="btn btn-primary">Learn more</a>
        </div>
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="<?= URL_TEMPLATE ?>img/landing/dashboard.png" alt="dashboard" class="img-responsive pull-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="<?= URL_TEMPLATE ?>img/landing/avatar3.jpg" class="img-responsive img-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="<?= URL_TEMPLATE ?>img/landing/avatar1.jpg" class="img-responsive img-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="<?= URL_TEMPLATE ?>img/landing/avatar2.jpg" class="img-responsive img-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="<?= URL_TEMPLATE ?>img/landing/iphone.jpg" class="img-responsive" alt="dashboard">
            </div>
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="<?= URL_TEMPLATE ?>" class="pull-left">
                        <img alt="image" src="<?= URL_TEMPLATE ?>img/landing/avatar3.jpg">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="<?= URL_TEMPLATE ?>" class="pull-left">
                        <img alt="image" src="<?= URL_TEMPLATE ?>img/landing/avatar1.jpg">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="<?= URL_TEMPLATE ?>" class="pull-left">
                        <img alt="image" src="<?= URL_TEMPLATE ?>img/landing/avatar2.jpg">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
...
<section id="contact" class="gray-section contact">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="<?= URL_TEMPLATE ?>mailto:test@email.com" class="btn btn-primary">Send us mail</a>
                <p class="m-t-sm">
...
<script src="<?= URL_TEMPLATE ?>js/plugins/wow/wow.min.js"></script>
